...
arrow(2.6, 4.05, 4.0, 4.05)
label(2.7, 4.15, "EN→BN", fontsize=7.0, ha="left", va="bottom")
...
arrow(5.2, 3.6, 5.2, 2.9)   # distill → filter
arrow(9.0, 3.6, 6.2, 2.9)   # BT → filter

# AgriEnBn corpus box
box(7.7, 2.0, 2.6, 0.9,
    "AgriEnBn\n3,034 pairs", *C_CORP, fontsize=9.5)
arrow(6.5, 2.45, 7.6, 2.45)

# Split labels beneath the corpus box
label(9.0, 1.75, "Train: 2,882  |  Dev: 152  |  Test: 198 (gold)", fontsize=7.0, color="#666", va="top")
...
# AgriBanglaT5 output
box(11.2, 0.4, 2.2, 0.9,
    "AgriBanglaT5\n(247M)", *C_MODEL, fontsize=9.5)
arrow(10.0, 0.85, 11.1, 0.85)

# Glossary hints
box(3.8, 0.4, 2.6, 0.9,
    "Glossary (82 terms)\nEN ↔ BN", *C_GLOSS, fontsize=8.5)
arrow(6.5, 0.85, 8.0, 0.85)
label(7.25, 1.0, "⟦hints⟧", fontsize=7.5, color="#1565c0", va="bottom")
